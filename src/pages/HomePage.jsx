      ...
      <section className="py-24 bg-[#F2E8DA] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-14">
            <div className="text-xs font-semibold tracking-[0.2em] uppercase text-[#B8651B] mb-4 flex items-center justify-center gap-2">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.slice(0, 6).map((t) => (
              <div key={t.id} className="card p-8 bg-white border border-[#E8DDD0]">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex gap-1">
                    {[...Array(t.rating)].map((_, i) => <Star key={i} className="w-4 h-4 text-[#E8A04E] fill-[#E8A04E]" />)}
                  </div>
                  <div className="text-xs font-medium text-[#7A6B5E]">{t.date}</div>
                </div>
